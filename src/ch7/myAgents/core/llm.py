...
class HelloAgentsLLM:
    ...
    - 输入参数优先，环境变量兜底
    - 流式响应为默认，提供更好的用户体验
    - 支持多种LLM提供商( openai, deepseek,qwen,modelscope,kimi,zhipu....local, ollama ...)
    - 统一的调用接口
    """
    ...
    def _get_default_model(self) -> str:
        ...
        if self.provider == "openai":
            ...
            return "Qwen/Qwen3.5-397B-A17B"  # TODO 这是我们使用的模型
    ...
    def think(
        ...
        try:
            response = self._client.chat.completions.create(
                ...
                ),  # self.temperature 是初始化时的温度值, temperature 是用户传入的温度值
            ...
            for chunk in response:
                ...
                if content:
                    ...
                    yield content  # yield表示返回一个流式响应的文本片段
            print()  # 在流式输出结束后换行
